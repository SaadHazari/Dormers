...
| 1 | DB timeouts + graceful fallback (L1) — Critical #1 | ⬜ | |
| 2 | Stripe money path (L2) | ⬜ | |
| 3 | Kill silent failures + observability (L5) — CX win | ⬜ | |
...
| Admin Panel | 5.5 | 5.5 | 10 |
| Kitchen Panel | 5.5 | 5.5 | 10 |
| Delivery Rider / Ops | 5.5 | 5.5 | 10 |
| Staff / Intern | 5.5 | 5.5 | 10 |
| Marketing + Auth | 5.8 | 5.8 | 10 |
| Payments / Checkout | 6.4 | 6.4 | 10 |
| User Dashboard | 6.5 | 6.5 | 10 |
| WhatsApp Messaging | 6.8 | 6.8 | 10 |
| Dorm Wars | 7.0 | 7.0 | 10 |
| Cron / Internal | 7.0 | 7.0 | 10 |
