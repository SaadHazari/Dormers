...
| Dorm Wars | 7.0 | 7.4 | 10 |
| Cron / Internal | 7.0 | 7.4 | 10 |
| Platform / Infra | 7.0 | 7.0 | 10 |

_Phase 0 + 1 landed. System ~6.1 → ~6.6 (L1 timeout coverage). Platform/Infra unchanged by L1; its env-validation foundation landed in Phase 0 but the deployment-dimension lift comes in Phase 8._
