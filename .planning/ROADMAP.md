...
| 5. Dorm Wars page visual revamp | 0/3 | Planned | - |
...
Plans:
- [ ] 05-01-PLAN.md — Wave 1: Structure swap — replace DormWarsClient.tsx + page.tsx with the mock's structure (single-file strategy); preserve hasClaimed/hasConverted state machine; drop MockDisclaimer
