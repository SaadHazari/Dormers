...
- [x] 09-03-PLAN.md — /api/ops/mark-delivered endpoint, iOS Shortcuts guide (public/shortcuts/README.md), compile/lint gate, visual verification checkpoint (PWA-01)
