...
// Time helpers moved to @/shared/time/dubai-day in Phase 2 of the layered
// refactor. Re-exported here as a compatibility shim so existing imports
// keep working until Phase 11 cleanup.
//
// New consumers should import directly from @/shared/time/dubai-day.
