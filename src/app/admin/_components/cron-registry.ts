...
export const JOB_INFO: Record<string, JobInfo> = {
    ...
    dispatch_subscription_ended_0045_ae: {
        label: '"Plan ended" message (10 AM)',
        does: 'Messages customers the morning after their plan finishes. While the season winds down or during the break it sends the season version with the waitlist credit.',
    ...
    dispatch_season_notices_tick: {
        label: 'Season messages (every 5 min)',
        does: 'Sends the queued season messages once they are due: the wrap-up split, last dinners, meals kept for next semester, a carried pause, meals ready.',
        impact: 'Customers are not hearing about the wrap-up day, their held meals or the reopening',
        group: 'customer',
        actionHref: '/admin/season',
        actionLabel: 'Open Season',
    },
    season_admin_digest_tick: {
        label: 'Season digest for you (6 PM)',
        does: 'WhatsApps you while the season winds down, only when something changed: plans running past the wrap-up day, credited skips, buffer grants, the last dinner on the books. Two days before the close day it sends the final roster.',
        impact: 'You are not told when the season picture changes',
        group: 'watchdog',
        actionHref: '/admin/season',
        actionLabel: 'Open Season',
    },
    season_admin_digest_tick_close_day: {
        label: 'Close-day note for you (8:30 PM)',
        does: 'On the close day, tells you what the kitchen cooks tonight and that the break starts at 00:20.',
        impact: 'No heads-up on the last kitchen night',
        group: 'watchdog',
        actionHref: '/admin/season',
        actionLabel: 'Open Season',
    },
