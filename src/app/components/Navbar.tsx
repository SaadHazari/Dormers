...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed w-11/12 md:w-[98%] shadow-md z-[100] rounded-3xl mx-auto left-0 right-0 mt-4 transition-colors duration-300 ${
              ...
              {navLinks.map((link) => (
                <a
                  ...
                  className={`transition-colors ${
                    theme === 'light' ? 'text-gray-700 hover:text-orange-500' : 'text-gray-300 hover:text-orange-400'
                  }`}
                style={{
