...
menu('active', 'Active plan — this week and next', 'Tonight\'s hero — date eyebrow, dish, "Non-veg · Medium" meta, Calories and Protein, live countdown — beside a photo that runs edge to edge and wears the frosted "Tonight" stamp. Below it this week\'s six cards (same photo treatment, day·date stamp, Delivered / Tonight pills, dish headline, meta line) and next week\'s preview strip. Plain cards are dinners that are coming: no "Upcoming" pill.', 'Active sub.')
